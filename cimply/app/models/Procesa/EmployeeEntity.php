...
namespace Cimply\App\Models\Procesa
{
    ...
    {
        protected $EmployeeID; protected $FirstName; protected $LastName; protected $EmpCode; protected $Position; protected $Office; protected $EMail;
        ...
        function identKeyValue($name = null): ?array {
            $result = [
                'EmployeeID' => ['EmployeeID = :EmployeeID' => (int)$this->EmployeeID],
