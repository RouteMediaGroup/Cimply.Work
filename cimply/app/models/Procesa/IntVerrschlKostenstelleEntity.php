...
namespace Cimply\App\Models\Procesa 
{
    ...
    abstract class IntVerrschlKostenstelleModel extends EntityBase implements IBasics
    {        
        ...
        function identKeyValue($name = null): ?array {
            $result = [
                'DokId' => ['DokId = :DokId' => (int)$this->DokId], 'INT_VERRECHNUNGSSCHLUESSEL' => ['INT_VERRECHNUNGSSCHLUESSEL = :INT_VERRECHNUNGSSCHLUESSEL' => (string)$this->INT_VERRECHNUNGSSCHLUESSEL]
            ];
    ...
    class IntVerrschlKostenstelleEntity extends IntVerrschlKostenstelleModel
    {
        public $table = 'INT_VERRSCHL_KOSTENSTELLE';
