...
namespace Cimply\App {
    ...
    class Run extends Basics
    {
        ...
        public function __construct(string $projectName, callable $autoloader, array $usings = [])
        {
            parent::__construct();
            ...
            $this->projectPath = str_replace('%project%', $projectName, \Cimply\App\Settings::ProjectPath);
