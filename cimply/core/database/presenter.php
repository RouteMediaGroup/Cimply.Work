...
namespace Cimply\Core\Database
{
    ...
    class Presenter extends Presenter\QueryBuilder {

        public function __construct($manager, $table) {
        ...
        private function setManager($manager = null) {
        ...
        public function execute($name = null, $value = null) {
